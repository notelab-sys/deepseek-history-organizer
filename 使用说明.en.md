...
- Semi-automated reference checking: `python scripts/verify_references.py references.md -o references.check.md`
...
| verify_references.py | Semi-automated reference checking (Crossref/DOI) |
